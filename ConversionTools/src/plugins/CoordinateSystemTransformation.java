...
public class CoordinateSystemTransformation implements WhiteboxPlugin {
    ...
    class CoordinateTransformDialog extends JPanel {
        ...
        private void initUi() {
            ...
            JRadioButton ll2utmButton = new JRadioButton("Geographic (Lat/Long) to UTM");
            //LL2UTMButton.setMnemonic(KeyEvent.VK_R);
            ll2utmButton.setActionCommand("ll2utm");
            ll2utmButton.setSelected(true);

            JRadioButton utm2llButton = new JRadioButton("UTM to Geographic (Lat/Long)");
...
//            //mainBox.add(box2);
        ...
        private void run() {
            ...
            if (projectionDirection.equals("ll2utm")) {
                ...
                ll2utm.convertLatLongDecDegrees(north, west);
                ...
                ll2utm.convertLatLongDecDegrees(north, east);
                easting = ll2utm.getEasting();
                northing = ll2utm.getNorthing();
                zone = ll2utm.getZone();
                if (easting < minEasting) {
                ...
                ll2utm.convertLatLongDecDegrees(south, east);
                easting = ll2utm.getEasting();
                northing = ll2utm.getNorthing();
                zone = ll2utm.getZone();
                if (easting < minEasting) {
                ...
                ll2utm.convertLatLongDecDegrees(south, west);
                easting = ll2utm.getEasting();
                northing = ll2utm.getNorthing();
                zone = ll2utm.getZone();
                if (easting < minEasting) {
                ...
                int inRow, inCol;
                UTM2LL utm2ll = new UTM2LL(ellipsoid);
                double inLat, inLng;
                ...
                for (int row = 0; row < outputRows; row++) {
                    for (int col = 0; col < outputCols; col++) {
                        ...
                        utm2ll.convertUTMCoordinates(outEasting, outNorthing, utmZone);
