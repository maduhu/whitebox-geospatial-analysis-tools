...
def name = "PercentEqualTo"
def descriptiveName = "Percent Equal To"
def description = "Calculates the percentage of a raster stack that have cell values equal to an input"
def toolboxes = ["OverlayTools"]

public class PercentEqualTo implements ActionListener {
	private WhiteboxPluginHost pluginHost
	private ScriptDialog sd
	private String descriptiveName
	private String name
	
	public PercentEqualTo(WhiteboxPluginHost pluginHost, 
...
if (args == null) {
	...
	def f = new PercentEqualTo(pluginHost, args, name, descriptiveName)
}
