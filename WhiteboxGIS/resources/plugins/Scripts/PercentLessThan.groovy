...
def name = "PercentLessThan"
def descriptiveName = "Percent Less Than"
def description = "Calculates the percentage of a raster stack that have cell values less than an input"
def toolboxes = ["OverlayTools"]

public class PercentLessThan implements ActionListener {
	private WhiteboxPluginHost pluginHost
	private ScriptDialog sd
	private String descriptiveName
	private String name
	
	public PercentLessThan(WhiteboxPluginHost pluginHost, 
...
if (args == null) {
	...
	def f = new PercentLessThan(pluginHost, args, name, descriptiveName)
}
