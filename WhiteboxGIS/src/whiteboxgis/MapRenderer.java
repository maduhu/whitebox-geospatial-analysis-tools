...
////                }
//
//                for (CartographicElement ce : mapinfo.getCartographicElementList()) {
//
...
//                                g2d.setColor(mapScale.getBackColour());
//
//                                g2d.fillRect(mapScale.getUpperLeftX(),
//                                        mapScale.getUpperLeftY(),
//                                        mapScale.getWidth(),
//                                        mapScale.getHeight());
//                            }
//
//                            g2d.setColor(mapScale.getLegendColour());
//
//                            if (mapScale.isBorderVisible() || mapScale.isSelected()) {
//                                if (!mapScale.isSelected()) {
//                                    g2d.setColor(mapScale.getBorderColour());
//                                } else {
//                                    g2d.setColor(selectedColour);
//                                }
//                                g2d.drawRect(mapScale.getUpperLeftX(),
//                                        mapScale.getUpperLeftY(),
//                                        mapScale.getWidth(),
//                                        mapScale.getHeight());
//                            }
//
//                            g2d.setColor(mapScale.getOutlineColour());
//
//                            // set up the font
...
//                            if (northArrow.getX() < 0) {
//                                northArrow.setX(rightEdge - northArrow.getMarkerSize() / 2 - 2);
//                                northArrow.setY(bottomEdge - northArrow.getMarkerSize() / 2 - 2);
//                            }
//
//                            if (northArrow.isBackgroundVisible()) {
//                                g2d.setColor(northArrow.getBackColour());
//
//                                g2d.fillRect(northArrow.getUpperLeftX(),
//                                        northArrow.getUpperLeftY(),
//                                        northArrow.getWidth(),
//                                        northArrow.getHeight());
//                            }
//
//                            if (northArrow.isBorderVisible()) {
//                                g2d.setColor(northArrow.getBorderColour());
//
//                                g2d.drawRect(northArrow.getUpperLeftX(),
//                                        northArrow.getUpperLeftY(),
//                                        northArrow.getWidth(),
//                                        northArrow.getHeight());
//                            }
//
//                            g2d.setColor(northArrow.getOutlineColour());
//                            BasicStroke myStroke = new BasicStroke(1);
//                            Stroke oldStroke = g2d.getStroke();
//                            g2d.setStroke(myStroke);
...
//
//                                if (mapTitle.getUpperLeftX() == -9999) {
//                                    mapTitle.setUpperLeftX((int)(leftEdge + ((rightEdge - leftEdge) - mapTitle.getWidth()) / 2.0));
//                                    mapTitle.setUpperLeftY(topEdge + 2);
//                                }
//                            }
//                            if (mapTitle.isBackgroundVisible()) {
//                                g2d.setColor(mapTitle.getBackColour());
//
//                                g2d.fillRect(mapTitle.getUpperLeftX(),
//                                        mapTitle.getUpperLeftY(),
//                                        mapTitle.getWidth(),
//                                        mapTitle.getHeight());
//                            }
//
//                            if (mapTitle.isBorderVisible()) {
//                                g2d.setColor(mapTitle.getBorderColour());
//
//                                g2d.drawRect(mapTitle.getUpperLeftX(),
//                                        mapTitle.getUpperLeftY(),
//                                        mapTitle.getWidth(),
//                                        mapTitle.getHeight());
//                            }
//                            font = mapTitle.getLabelFont();
//                            g2d.setColor(mapTitle.getFontColour());
//                            oldFont = g2d.getFont();
//                            g2d.setFont(font);
//                            metrics = g.getFontMetrics(font);
//                            int fontHeight = metrics.getHeight() - metrics.getDescent();
...
//                            g2d.drawString(mapTitle.getLabel(), x, y);
//                            g2d.setFont(oldFont);
//                        }
//
//                    }
...
//        for (CartographicElement ce : mapinfo.getCartographicElementList()) {
//            if (isBetween(x, ce.getUpperLeftX(), ce.getLowerRightX())
//                    && isBetween(y, ce.getUpperLeftY(), ce.getLowerRightY())) {
...
//                    }
//
//                    whichCartoElement = ce.getElementNumber(); //CARTO_ELEMENT_SCALE;
//
...
////                    }
//                    mapElementX = x - ce.getUpperLeftX();
//                    mapElementY = y - ce.getUpperLeftY();
//                    withinElement = true;
//                }
//            }
//
...
//            CartographicElement ce = mapinfo.getCartographicElement(whichCartoElement);
//            ce.setUpperLeftX(e.getX() - mapElementX);
//            ce.setUpperLeftY(e.getY() - mapElementY);
//            mapinfo.modifyElement(whichCartoElement, ce);
//            this.repaint();
//            
...
//                wbg.showMapProperties(whichCartoElement);
//            }
//            
