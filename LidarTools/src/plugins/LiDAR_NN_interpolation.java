...
//                //KdTree<Double> pointsTree; // = new KdTree.SqrEuclid<Double>(2, new Integer(numPoints));
//            
//                double[][] data = readLASData(pointFiles[j], returnNumberToInterpolate, whatToInterpolate, classValuesToExclude);
//                numPoints = data[0].length;
//                
//                // tile the data
//                int numTilesX = (int)Math.ceil((maxX - minX) / maxDist);
//                int numTilesY = (int)Math.ceil((maxY - minY) / maxDist);
//                int numTiles = numTilesX * numTilesY;
//                int tileNum, tileRow, tileCol;
//                double[][] tileData = new double[numTiles][];
//                int[] numPointsInTile = new int[numTiles];
//                
//                for (a = 0; a < numPoints; a++) {
//                    tileCol = (int)((data[1][a] - minX) / maxDist);
//                    tileRow = (int)((maxY - data[0][a]) / maxDist);
//                    tileNum = tileRow * numTilesX + tileCol;
//                    numPointsInTile[tileNum]++;
//                }
//                
//                int k = 0;
//                
...
////                            }
////                            
////                            pointsTree.addPoint(new double[]{y, x}, z);
////
////                            if (x < minX) {
////                                minX = x;
////                            }
...
//    }
//    
//    private double[][] readLASData(String fileName, String returnNumberToInterpolate, String whatToInterpolate, boolean[] classValuesToExclude) {
//        int progress = 0;
//        double x, y;
//        double z = 0;
//        long numPointsInFile = 0;
...
//        PointRecColours pointColours;
//        int a;
//        LASReader las = new LASReader(fileName);
//
//        numPointsInFile = las.getNumPointRecords();
//        // first count how many valid points there are.
//        numPoints = 0;
...
//        LiDAR_NN_interpolation nn = new LiDAR_NN_interpolation();
//        args = new String[17];
//        args[0] = "/Users/johnlindsay/Documents/Data/Picton data/1km183270487302008GROUPEALTA.las";
//        //args[0] = "/Users/johnlindsay/Documents/Data/u_5565073175.las";
//        //args[0] = "/Users/johnlindsay/Documents/Data/u_5565073250.las";
//        args[1] = " last return";
//        args[2] = "elevation";
