...
public class PageFormatSerializer implements JsonSerializer<PageFormat> { 
    @Override
    public JsonElement serialize(PageFormat t, Type type, JsonSerializationContext jsc)
    {
        ...
        //jo.addProperty("mPaper", gson.toJson(t.getPaper()));
        jo.add("mPaper", gson.toJsonTree(t.getPaper()));
        jo.addProperty("mOrientation", t.getOrientation());   
        return jo;
    }
}
