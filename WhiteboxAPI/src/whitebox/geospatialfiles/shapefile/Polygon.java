...
public class Polygon implements Geometry {
     ...
     * is read directly from a file.
     *
     * @param rawData A byte array containing all of the raw data needed to
     * create the Polygon, starting with the bounding box, i.e. leaving out the
     * ShapeType data.
     */
     ...
     * that the vertices for polygon holes must be entered in a
     * counter-clockwise order as per the ShapeFile specifications.
     *
